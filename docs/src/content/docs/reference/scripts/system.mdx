...
Agent that can query code





`````js wrap title="system.agent_code"
system({
...
Source code query using Treesitter



-  tool `code_query`: Uses tree-sitter to query code

`````js wrap title="system.code_query"
system({
